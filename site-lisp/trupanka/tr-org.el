...
(use-package org :demand
  ...
  (setq org-todo-keywords
	'((sequence
	   ...
	   "SOMEDAY(#)" "FROZEN(f!)" "|" "DONE(d!)" "CANCELLED(c@)")
  ...
  (setq org-todo-state-tags-triggers
	'(("STARTED" ("ACTIVE" . t) ("PENDING") ("FROZEN"))
	  ("PROGRESS" ("ACTIVE" . t) ("PENDING") ("FROZEN"))
	  ("WAITING" ("ACTIVE") ("PENDING" . t) ("FROZEN"))
	  ("DEPENDENCY" ("DEPENDENCY" . t) ("ACTIVE") ("PENDING") ("FROZEN"))
	  ("" ("ACTIVE") ("PENDING") ("FROZEN"))
	  ("TODO" ("ACTIVE") ("PENDING") ("FROZEN"))
	  ("NEXT" ("ACTIVE") ("PENDING") ("FROZEN"))
	  ("SOMEDAY" ("ACTIVE") ("PENDING") ("FROZEN"))
	  ("FROZEN" ("FROZEN" . t) ("ACTIVE") ("PENDING"))
	  (done ("ACTIVE") ("PENDING") ("FROZEN"))))
  ...
  (setq org-stuck-projects
	'("+#project+LEVEL=2/-SOMEDAY-FROZEN-DONE-COMPLETE-ACHIVED-CANCELLED" ("NEXT" "STARTED" "PROGRESS") nil "\\<IGNORE\\>"))
...
(use-package org-agenda :demand
  ...
  (setq org-agenda-tag-filter-preset '("-DEPENDENCY" "-FROZEN" "-#note" "-#journal"))
